...
export const RenderedData = ({
  ...
  return (
    <>
      <NewsHeading>
        <NewsCardHeadingTitle title="Berita Syariah" />
        <p>
          Berita terkini dari isu syariah di indonesia dan Internasional yang
          sedang berlangsung
        </p>
      </NewsHeading>
      <NewsSearch
...
export default function BeritaKesehatan() {
  ...
  // Set title
  let pageTitle =
    "Berita terkini dari isu syariah di indonesia dan Internasional yang sedang berlangsung";
