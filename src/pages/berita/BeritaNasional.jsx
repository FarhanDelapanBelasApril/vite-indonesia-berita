...
import { useGetNasionalNews } from "../../hooks/NewsCnnHook";
import {
  NewsHeading,
...
export const RenderedData = ({
  ...
  return (
    <>
      <NewsHeading>
        <NewsCardHeadingTitle title="Berita Nasional" />
    ...
    <>
      <Helmet>
        ...
        <meta
          name="title"
          property="og:title"
          content="Berita terkini dari isu dalam negeri yang sedang berlangsung"
        />
        <meta
          name="description"
