    ...
    <>
      <CardHeading>
        <div className="d-flex justify-content-between g-2 flex-wrap">
          ...
          <CardHeadingBreadcrumb linkName="Berita Internasional" />
        </div>
        <p>Berita terkini dari isu internasional yang sedang berlangsung</p>
      </CardHeading>
      <SearchNews
        items={items}
...
export default function BeritaInternasional() {
  ...
  // Set title
  let pageTitle =
    "Berita terkini dari isu internasional yang sedang berlangsung";
