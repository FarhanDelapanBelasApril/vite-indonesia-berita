...
import { useGetLatestNews } from "../../hooks/useNewsCnbcHooks";
import {
    ...
    <>
      <CardHeading>
        <div className="d-flex justify-content-between g-2 flex-wrap">
          <CardHeadingTitle title="Berita Terbaru" />
          <CardHeadingBreadcrumb linkName="Berita Terbaru" />
        </div>
        <p>
          Berita peristiwa terbaru di Indonesia dan luar negeri yang sedang
          berlangsung
        </p>
      </CardHeading>
      <SearchNews
...
export default function BeritaTerbaru() {
  ...
  const {
    ...
    isError,
    error,
  } = useGetLatestNews(currentPage);

  // Set title
  let pageTitle =
    "Berita peristiwa terbaru di Indonesia dan luar negeri sedang berlangsung";
