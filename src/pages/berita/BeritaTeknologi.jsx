...
import { useGetTeknologiNews } from "../../hooks/useNewsCnnHooks";
import {
    ...
    <>
      <CardHeading>
        <div className="d-flex justify-content-between g-2 flex-wrap">
          <CardHeadingTitle title="Berita Teknologi" />
          <CardHeadingBreadcrumb linkName="Berita Teknologi" />
        </div>
        <p>
          Berita teknologi terkini di Indonesia dan Internasional sedang
          berlangsung
        </p>
      </CardHeading>
      <SearchNews
...
export default function BeritaTeknologi() {
  ...
  const {
    ...
    isError,
    error,
  } = useGetTeknologiNews(currentPage);

  // Set title
  let pageTitle =
    "Berita teknologi terkini di Indonesia dan luar negeri sedang berlangsung";
