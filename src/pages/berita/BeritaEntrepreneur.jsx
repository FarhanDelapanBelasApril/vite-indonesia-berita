...
import { useGetEntrepreneurNews } from "../../hooks/useNewsCnbcHooks";
import {
  NewsHeading,
...
export const RenderedData = ({
  ...
  return (
    <>
      <NewsHeading>
        <NewsCardHeadingTitle title="Berita Entrepreneur" />
        <p>
          Berita terkini dari isu Entrepreneur di indonesia dan Internasional
...
export default function BeritaEntrepreneur() {
  ...
  const {
    ...
    isError,
    error,
  } = useGetEntrepreneurNews(currentPage);

  // Set title
  let pageTitle =
    "Berita terkini dari isu Entrepreneur di indonesia dan Internasional yang sedang berlangsung";
    ...
    <>
      <Helmet>
        ...
        <meta
          name="title"
          property="og:title"
          content="Berita terkini dari isu Entrepreneur di indonesia dan Internasional yang sedang berlangsung"
        />
        <meta
          name="description"
