...
export const RenderedData = ({
  ...
  return (
    <>
      <NewsHeading>
        <NewsCardHeadingTitle title="Berita Market" />
        <p>
          Berita terkini dari isu market / penjualan di indonesia dan
...
export default function BeritaKesehatan() {
  ...
  // Set title
  let pageTitle =
    "Berita terkini dari isu market / penjualan di indonesia dan Internasional yang sedang berlangsung";
