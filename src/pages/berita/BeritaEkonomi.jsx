...
import { useGetEkonomiNews } from "../../hooks/useNewsCnnHooks";
import {
    ...
    <>
      <CardHeading>
        <div className="d-flex justify-content-between g-2 flex-wrap">
          <CardHeadingTitle title="Berita Ekonomi" />
          <CardHeadingBreadcrumb linkName="Berita Ekonomi" />
        </div>
        <p>
          Berita terkini dari isu Ekonomi di indonesia dan Internasional yang
          sedang berlangsung
        </p>
      </CardHeading>
      <SearchNews
...
export default function BeritaEkonomi() {
  ...
  const {
    ...
    isError,
    error,
  } = useGetEkonomiNews(currentPage);

  // Set title
  let pageTitle =
    "Berita terkini dari isu Ekonomi di indonesia dan Internasional yang sedang berlangsung";
