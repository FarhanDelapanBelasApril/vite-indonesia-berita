...
export default function LatestNewsFeatured() {
  const { data: items, isLoading, isSuccess } = useGetAllNews(1);
  ...
  return (
    <div>
      <CardHeading>
        <div className="d-flex justify-content-between flex-wrap g-2 pt-3">
